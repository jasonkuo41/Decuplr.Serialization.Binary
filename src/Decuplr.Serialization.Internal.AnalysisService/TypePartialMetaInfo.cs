...
namespace Decuplr.Serialization.AnalysisService {
    public class TypePartialMetaInfo {
        ...
        internal TypePartialMetaInfo(NamedTypeMetaInfo source, SourceCodeAnalysis analysis, SyntaxModelPair syntaxPair, IReadOnlyList<SymbolKind> kinds, CancellationToken ct) {
