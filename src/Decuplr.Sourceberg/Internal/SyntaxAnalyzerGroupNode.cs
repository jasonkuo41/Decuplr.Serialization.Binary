...
namespace Decuplr.Sourceberg.Internal {
    internal class SyntaxAnalyzerGroupNode<TSourceAnalyzer, TSyntax> : AnalyzerGroupNode<SyntaxNode, SyntaxNodeAnalysisContextSource>, ISyntaxAnalyzerSetupGroup<TSyntax>
