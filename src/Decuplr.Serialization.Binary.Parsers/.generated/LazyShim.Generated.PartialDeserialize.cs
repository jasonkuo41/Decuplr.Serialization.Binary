...
internal LazyShim (in LazyShim_XAF96RTGJHE73_TypeParserArgs<T> parsers, ReadOnlySpan<byte> span, out int readBytes, out DeserializeResult result) {
readBytes = -1;
var originalSpanLength = span.Length;
{
// Configure for argument LazyValue
var currentReadBytes = 0;
result = TryDeserialize_LazyValue (in parsers, span, out currentReadBytes, out var desResult);
LazyValue = desResult;
...
DeserializeResult TryDeserialize_LazyValue (in LazyShim_XAF96RTGJHE73_TypeParserArgs<T> parsers,ReadOnlySpan<byte> providedSpan, out int readBytes, out T value){
