...
namespace Decuplr.Serialization.Binary.AnalyzeService {
    internal class TypeMetaInfo {
        ...
        internal TypeMetaInfo(SourceCodeAnalysis analysis, INamedTypeSymbol symbol, IEnumerable<SyntaxModelPair> syntax, IReadOnlyList<SymbolKind> kinds, CancellationToken ct) {
