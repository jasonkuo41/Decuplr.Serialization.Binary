...
namespace Decuplr.Serialization.Binary.LayoutService {
    ...
    internal partial class DiagnosticHelper {
        ...
        public static Diagnostic UnsupportedTypeHint(MemberMetaInfo member) => CreateDiagnostic(member.Location, new object?[] { member.ReturnType?.Name, member.MemberSymbol, member.ReturnType?.TypeKind });
        ...
        public static Diagnostic ExplicitDontNeedIgnore(MemberMetaInfo member)
            => CreateDiagnostic(member.Location, new object[] { member.MemberSymbol });
        ...
        public static Diagnostic DuplicateIndexs(int index, MemberMetaInfo firstMember, MemberMetaInfo secondMember)
            => CreateDiagnostic(secondMember.Location, new object[] { index, firstMember.MemberSymbol, secondMember.MemberSymbol });
