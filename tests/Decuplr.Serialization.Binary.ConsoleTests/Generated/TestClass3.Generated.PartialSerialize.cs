...
internal static void ___generated__no_invoke_TestClass3_Derializer (Decuplr.Serialization.Binary.ConsoleTests.TestClass3 value, out Decuplr.Serialization.Binary.ConsoleTests.FoamStruct s_0,out System.Collections.Generic.List<byte> s_1,out (bool IsValid, bool IsCurrent, bool IsCompressed) s_2){
s_0 = InfoData;
s_1 = FormatData;
s_2 = ConditionGroup;
}
